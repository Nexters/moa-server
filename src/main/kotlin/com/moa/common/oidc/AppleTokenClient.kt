...
class AppleTokenClient(
    ...
    @Value("\${oidc.apple.token-uri:https://appleid.apple.com/auth/token}") private val tokenUri: String,
    @Value("\${oidc.apple.client-id:}") private val clientId: String,
    @Value("\${oidc.apple.redirect-uri:}") private val redirectUri: String,
    @Value("\${oidc.apple.token-connect-timeout-seconds:3}") connectTimeoutSeconds: Long,
    @Value("\${oidc.apple.token-read-timeout-seconds:5}") readTimeoutSeconds: Long,
